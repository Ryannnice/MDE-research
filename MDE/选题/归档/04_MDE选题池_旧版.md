...
> 配套:`MDE/文献调研/单目深度估计综述.md`、`MDE/文献调研/单目深度估计前沿方向汇总调研.md`、`papers/`
...
>
> 📖 **先读机制地基**:本卡是决策/立项视角,假定你已懂扩散深度的机制谱系。若要先建直觉,读 `MDE/文献调研/单目深度估计前沿方向汇总调研.md` **B3(扩散深度主线)**:B3.1 范式(Marigold)→ B3.2 提速谱系(E2E-FT/Lotus/DepthFM)→ B3.3 单步内核(ChordEdit/OT/Tweedie)→ B3.4 米制化(GeoDiff/Defocus/AnchorD)→ B3.5 精读路线。可执行实验层见 `MDE/选题/归档/02_A2实验方案_旧版.md`,机制代码自检见 `a2/A2_ccf_depth_skeleton.py`。
...
- **2026-06-22 ⑦机制谱系沉到前沿追踪层**:应主攻聚焦需求,把 A② 的扩散深度机制谱系重构进 `MDE/文献调研/单目深度估计前沿方向汇总调研.md` **B3**(B3.1 范式→B3.2 提速→B3.3 单步内核→B3.4 米制→B3.5 精读路线),作为本立项卡的"机制地基"。本卡 §4 标题下加指针指向 B3;综述报告 §9.6、前沿追踪 5 处旧 `8.5` 死链一并修正(原 §8.5 在 ④重构时已并入本 §4)。**内容零新增,纯重组 + 死链修复 + 阅读动线**;go/no-go 不变。
