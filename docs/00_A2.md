...
- `docs/选题/01_代理锚定CCF近单步米制扩散深度.md`: 当前 A2/I1 立项卡。
- `docs/选题/归档/01_A2选题图_旧版.md`: 原 idea map。
- `docs/选题/归档/02_A2实验方案_旧版.md`: 完整实验方案和历史复核记录。
- `docs/文献调研/归档/03_MDE前沿追踪_全文.md`: 原大规模前沿追踪。
- `docs/选题/归档/04_MDE选题池_旧版.md`: 旧选题池。
- `docs/文献调研/归档/05_MDE综述通读_全文.md`: 综述通读。

长文保留历史上下文,当前执行以本文件为准。
